...
def test_data_pipeline():
    ...
    logger_paddle_data.save("./test_tipc/result/data_paddle.npy")
    logger_torch_data.save("./test_tipc/result/data_ref.npy")
...
if __name__ == "__main__":
    ...
    torch_info = diff_helper.load_info("./test_tipc/result/data_ref.npy")
    paddle_info = diff_helper.load_info("./test_tipc/result/data_paddle.npy")

    # compare result and produce log
    diff_helper.compare_info(torch_info, paddle_info)
    diff_helper.report(path="./test_tipc/result/log/data_diff.log")
